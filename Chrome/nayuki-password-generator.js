...
document.getElementById("submit-button").addEventListener("click", function doGenerate(e) {
	e.preventDefault();
...
document.getElementById("copy-button").addEventListener("click", function doCopy() {
